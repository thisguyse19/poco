...
export const OOBE_TOUR_STEPS: OobeTourStepDef[] = [
  {
    ...
    anchor: null,
    title: 'Welcome',
    body: 'Sample tasks only: nothing here sticks until you finish the tour. The rest of the screen soft-blurs so your eyes stay on the highlighted bit. Tap Next when you want the first hands-on step.',
  },
  {
    path: '/',
    anchor: 'quickadd',
  ...
  },
  {
    ...
    body: 'Swipe a demo row sideways, or use the Later / Tomorrow buttons. Try it on any sample task. The tour moves on when you reschedule one.',
