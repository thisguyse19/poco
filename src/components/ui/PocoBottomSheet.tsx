  ...
  return createPortal(
    <>
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        className={`fixed inset-x-0 bottom-0 z-[var(--poco-z-sheet-panel)] mx-auto flex max-h-[min(92dvh,calc(100dvh-env(safe-area-inset-top)))] max-w-lg flex-col border border-b-0 border-[var(--border-default)] bg-[var(--bg-elevated)] shadow-[0_-8px_32px_rgba(0,0,0,0.12)] md:bottom-4 md:z-[var(--poco-z-sheet-panel-md)] md:max-h-[90dvh] md:border-b md:shadow-xl ${sheetClassName}`}
        style={{
          transform,
          transition,
